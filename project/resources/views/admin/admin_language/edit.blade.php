...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Edit Admin Panel Language') }}
    <a href="{{ route('admin-lang-admin-index') }}" class="btn back-btn btn-sm text-white">{{__('Back')}}</a>
    </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('Dashboard') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Edit Admin Panel Language') }}</li>
        </ol>
    </div>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3 col-lg-3 offset-4">
                            ...
                            <form action="{{route('admin.lang.import')}}" method="post" enctype="multipart/form-data">@csrf
                    ...
                    <form action="{{route('admin-lang-admin-update',$data->id)}}" enctype="multipart/form-data" method="POST" id="pageForm">
                        @csrf
