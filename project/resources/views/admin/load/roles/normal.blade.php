    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Hotel Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Tour Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Space Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Car Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('General Settings Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Home Page Settings Section'))
...
@if(Auth::guard('admin')->user()->sectionCheck('Payment Settings Section'))
...
@if(Auth::guard('admin')->user()->sectionCheck('Menu Page Settings Section'))
...
@if(Auth::guard('admin')->user()->sectionCheck('Blog Section'))
<li class="nav-item ">
...
@endif
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Email Settings Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Social Settings Section'))
    ...
    @endif
    @if(Auth::guard('admin')->user()->sectionCheck('Location Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Language Section'))
...
@if(Auth::guard('admin')->user()->sectionCheck('Seo Tools Section'))
...
@if(Auth::guard('admin')->user()->sectionCheck('Manage Staff Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('User Manage Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Manage Role Section'))
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Subscriber Section'))
