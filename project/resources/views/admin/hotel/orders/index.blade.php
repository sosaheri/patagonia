...
@php
if(Request::path() == 'admin/hotel/orders/all'){
    $name = __('All Orders');
    $ajax = 'all';
}elseif(Request::path() == 'admin/hotel/orders/pending'){
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <form action="{{route('admin.bulk.delete')}}" id="bulk-delete" class="d-flex flex-row align-items-center">
                        ...
                        <input type="hidden" name="order_type" value="hotel">
...
@section('script')
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-hotel-datatables-orders',$ajax) }}',
               columns: [
