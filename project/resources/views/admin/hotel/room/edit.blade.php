...
<div class="container-fluid" id="container-wrapper">
    ...
    <a href="{{ url()->previous() }}" class="btn back-btn btn-sm">{{__('Back')}}</a>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin-hotel-room',$data->hotel_id)}}">{{ __('Hotel Room') }}</a></li>
        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{route('admin-hotel-room-update',$data->id)}}" enctype="multipart/form-data" method="POST" id="pageForm">
                        @csrf
                       <input type="hidden" name="hotel_id" value="{{$data->hotel_id}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$data->square_fit}}" name="square_fit" id="square_fit" placeholder="{{ __('Square Fit') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.1" class="form-control" name="per_night_cost" id="per_night_cost" placeholder="{{ __('Per Night Cost') }}" value="{{PriceHelper::showAdminPrice($data->per_night_cost)}}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
				...
				<div class="gallery-images">
					<div class="selected-image">
						<div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="img gallery-img"><span class="remove-img" data-href="{{route('hotel.room.gallery.remove',$gallery->id)}}"><i class="fas fa-times"></i><input type="hidden" value="{{$key}}"></span>
