...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin-hotel-index')}}">{{ __('Hotel') }}</a></li>
    ...
    <form action="{{route('admin-hotel-update',$main->id)}}" enctype="multipart/form-data" method="POST" id="pageForm" >
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <!-- Form Basic -->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="text-center banner_image_view mb-2">
                                        <img class="img-profile" src="{{$main->banner_image ? asset('assets/images/hotel-image/banner-image/'.$main->banner_image) : asset('assets/images/placeholder.jpg')}}" >
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="0.1" min="0" class="form-control" name="main_price" value="{{PriceHelper::showAdminPrice($main->main_price)}}" id="main_price" placeholder="{{ __('Current Price') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="sale_price">{{ __('Previous Price') }} ({{PriceHelper::showCurrency()}})</label>
                                    <input type="text" step="0.1" min="0" class="form-control" name="sale_price" value="{{PriceHelper::showAdminPrice($main->sale_price)}}" id="sale_price" placeholder="{{ __('Previous Price') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="discount">{{ __('Discount') }} (%)</label>
                                    <input type="text" class="form-control" name="discount" value="{{$main->discount}}" id="discount" placeholder="{{ __('Discount') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="show-extra-price {{$main->extra_price ? '' : 'd-none'}}">
                            <div id="price-section">
                                @if($main->extra_price) @foreach (explode(',,,',$main->extra_price) as $key => $extra_price) 
                                @php 
                                $nameprice = (explode(',,,',$main->extra_price_name)[$key]); 
                                ...
                                <div class="language-area position-relative">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-4">
                                            <div class="form-group ">
                                                <input step="0.1" min="0" type="number" name="extra_price[]" class="form-control" placeholder="{{__('Enter Price')}}" required="" value="{{PriceHelper::showAdminPrice($extra_price)}}" />
                                            </div>
                                        </div>
                                        <div class="col-sm-4 col-md-4 col-4">
                                            <div class="form-group ">
                ...
                <div class="card">
                    ...
                    <div class="form-group p-3">
                        <select class=" form-control" name="user_id">
                            <option value="" selected>{{__('My Hotel')}}</option>
						...
						<div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="img gallery-img"><span class="remove-img" data-href="{{route('hotel.gallery.image.remove',$gallery->id)}}"><i class="fas fa-times"></i><input type="hidden" value="{{$key}}"></span>
                                    <a href="{{asset('assets/images/hotel-image/gallery/'.$gallery->image)}}" target="_blank"><img src="{{asset('assets/images/hotel-image/gallery/'.$gallery->image)}}" alt="gallery image"></a>
                                </div>
                            </div>
                            @endforeach
						</div>
