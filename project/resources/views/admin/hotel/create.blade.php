...
<div class="container-fluid" id="container-wrapper">
    ...
    <form action="{{route('admin-hotel-store')}}" enctype="multipart/form-data" method="POST" id="pageForm">
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <!-- Form Basic -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="discount" id="discount" placeholder="{{ __('Discount') }}">
                                </div>
                            </div>
                        </div>
