...
@php
if(Request::path() == 'admin/space/orders/all'){
    $name = __('All Orders');
    $ajax = 'all';
}elseif(Request::path() == 'admin/space/orders/pending'){
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <form action="{{route('admin.bulk.delete')}}" id="bulk-delete" class="d-flex flex-row align-items-center">
                        ...
                        <input type="hidden" name="order_type" value="space">
...
@section('script')
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-space-datatables-orders',$ajax) }}',
               columns: [
