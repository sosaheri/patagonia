...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                <div class="card-body">
                    <form id="pageFormTable" action="{{route('admin-spaceterm-store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ __('Name') }}</label>
                            <input type="text" class="form-control" name="name" value="" id="name" placeholder="{{ __('Name') }}">
                        </div>
                        <input type="hidden" value="{{$attribute->id}}" name="space_attr_id">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <form action="{{route('admin.bulk.delete')}}" id="bulk-delete" class="d-flex flex-row align-items-center">
                        <input type="hidden" name="table" value="space_terms">
    ...
    <script type="text/javascript">
       $(function ($) {
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-spaceterm-datatables',$attribute->id) }}',
               columns: [
