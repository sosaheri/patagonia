...
<div class="container-fluid" id="container-wrapper">
    ...
    <form action="{{route('admin-tour-store')}}" enctype="multipart/form-data" method="POST" id="pageForm">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <!-- Form Basic -->
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" autocomplete="off" id="duration" class="form-control" name="duration" placeholder="{{__('Enter Duration')}}">
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="text-center banner_image_view mb-2">
                                        <img class="img-profile" src="{{asset('assets/images/placeholder.jpg')}}">
                                    </div>
                ...
                <div class="card mb-4 p-3">
                    ...
                    <div class="card-body">
                        <div class="row border-buttom">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="main_price" id="price" placeholder="{{ __('Current Price') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="custom-control custom-switch mb-3 mt-3">
                            ...
                            <label class="custom-control-label" for="persion_type">{{__('Enable Person Types')}}</label>
                        </div>
                ...
                <div class="card ">
                    ...
                    <div class="form-group p-3">
                        <select class=" form-control" name="user_id">
                            <option value="" selected>{{__('My Tour')}}</option>
