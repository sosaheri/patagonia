...
@section('content')
<input type="hidden" id="headerdata" value="{{ __('TOUR CATEGORY') }}">
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">{{ __('Tour Category') }}</h1>
      <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('Dashboard') }}</a></li>
          <li class="breadcrumb-item active" aria-current="page">{{ __('Tour Category') }}</li>
      </ol>
  </div>
          ...
          <div class="card mb-4">
            <div class="card-header">
                <form action="{{route('admin.bulk.delete')}}" id="bulk-delete" class="d-flex flex-row align-items-center">
                    <input type="hidden" name="table" value="tour_categories">
 ...
 $(function ($) {
       "use strict";
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-tour-cat-datatables') }}',
               columns: [
        ...
        '<a class="btn btn-primary " href="javascript:;" data-href="{{route('admin-tour-cat-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
