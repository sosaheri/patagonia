          ...
          <div class="card mb-4">
            <div class="card-header">
                <form action="{{route('admin.bulk.delete')}}" id="bulk-delete" class="d-flex flex-row align-items-center">
                    <input type="hidden" name="table" value="car_attrs">
...
@section('script')
    ...
    $(function ($) {
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-carattr-datatables') }}',
               columns: [
        ...
        '<a class="btn btn-primary " href="javascript:;" data-href="{{route('admin-carattr-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
