...
@php
if(Request::path() == 'admin/car/orders/all'){
    $name = __('All Orders');
    $ajax = 'all';
}elseif(Request::path() == 'admin/car/orders/pending'){
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <form action="{{route('admin.bulk.delete')}}" id="bulk-delete" class="d-flex flex-row align-items-center">
                        ...
                        <input type="hidden" name="order_type" value="car">
...
@section('script')
    ...
    $(function ($) {
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-car-datatables-orders',$ajax) }}',
               columns: [
