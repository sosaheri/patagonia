...
<div class="container-fluid" id="container-wrapper">
    ...
    <form action="{{route('admin-car-update',$main->id)}}" enctype="multipart/form-data" method="POST" id="pageForm" >
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <!-- Form Basic -->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="text-center banner_image_view mb-2">
                                        <img class="img-profile" src="{{$main->banner_image ? asset('assets/images/car/banner-image/'.$main->banner_image) : asset('assets/images/placeholder.jpg')}}">
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="show-extra-price {{$main->extra_price ? '' : 'd-none'}}">
                            <div id="price-section">
                                ...
                                @foreach (explode(',,,',$main->extra_price_name) as $key => $extra_price_name) @php $extra_price = explode(',,,',$main->extra_price)[$key]; $type = (explode(',,,',$main->extra_price_type)[$key]); @endphp
                                <div class="language-area position-relative">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-4">
                                            <div class="form-group ">
                                                <select name="extra_price_type[]" class="form-control" required>
                                                    ...
                                                    <option value="per dey" {{$type=='per dey' ? 'selected' : ''}}>{{__('Per Day')}}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card mt-3">
                    ...
                    <div class="form-group p-3">
                        ...
                        <option value="">{{__('Select User')}}</option>
                            ...
                            <option value="{{$user->id}}" {{$main->user_id == $user->id ? 'selected' : ''}}>{{$user->name}}</option>
                            @endforeach
                          </select>
                    </div>
                </div>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="text-center ShowLanguageImage mb-4">
                            <img class="img-profile" src="{{$main->image->image ? asset('assets/images/car/feature-image/'.$main->image->image) : asset('assets/images/placeholder.jpg')}}" >
                        </div>
                        <div class="custom-file">
...
@section('script')
    <script src="{{asset('assets/admin/js/car/car.js')}}"></script>
@endsection