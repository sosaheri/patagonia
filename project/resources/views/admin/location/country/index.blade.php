...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Country') }}</h1>
        <ol class="breadcrumb">
...
@section('script')
    ...
    $(function() {
        ...
        '<a class="btn btn-primary " href="javascript:;" data-href="{{route('admin.country.create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
