...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Create Website Language') }}
    <a href="{{ route('admin-lang-index') }}" class="btn back-btn btn-sm">{{__('Back')}}</a>
    </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('Dashboard') }}</a></li>
            <li class="breadcrumb-item"><a href="{{route('admin-lang-index')}}">{{ __('Language') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Create Website Language') }}</li>
        </ol>
    </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{route('admin-lang-store')}}" enctype="multipart/form-data" method="POST" id="pageForm">
                        @csrf
                            <div class="row mb-2">
