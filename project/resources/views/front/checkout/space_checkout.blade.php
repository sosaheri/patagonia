                    ...
                    <div class="col-lg-4">
                        <div class="booking-info">
                            <div class="top-area">
                                ...
                                <p class="location"><i class="fas fa-map-marker-alt"></i> {{$space['space']->country->country}}, {{$space['space']->state->state}}</p>
                                <div class="image">
                                    <img src="{{asset('assets/images/space/feature-image/'.$space['space']->image->image)}}" alt="">
                                </div>
                            </div>
                            <div class="area-two">
                                <ul>
                            ...
                            <div class="area-three">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <span>{{$e_p_name}}: <small>({{str_replace('_',' ',$space['fac_type'][$key])}})</small></span>
