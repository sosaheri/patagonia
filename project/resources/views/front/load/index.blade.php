...
<div class="row">
	...
	{{ $tours->appends(['minprice' => request()->input('minprice'), 'maxprice' => request()->input('maxprice'), 'country_id' => request()->input('country_id'), 'sort' => request()->input('sort'), 'review' => request()->input('review'),'view' => request()->input('view')])->links() }}
</div>
@else
			...
			<div class="single-tours">
				...
				<div class="content">
					<span class="add-favotite corsor-pointer" data-href="{{route('front.favarite',$hotel->id.',,hotel')}}">
						@if(App\Models\Favarite::where('data_id',$hotel->id)->where('type','tour')->exists())
							<i class="fas fa-check"></i>
						@else
						<i class="far fa-heart"></i>
						@endif
					...
					<h4 class="title">
						<a href="{{route('tour.details',$hotel->slug)}}">{{$hotel->title}}</a>
					</h4>
					<div class="review-area">
						<div class="stars">
							<div class="ratings">
...
<div class="row">
		...
		<div class="col-lg-4 col-md-6">
			<div class="single-tours">
				...
				<div class="content">
					...
					<h4 class="title">
						<a href="{{route('tour.details',$car->slug)}}">{{$car->title}}</a>
					</h4>
					<div class="review-area">
						<div class="stars">
							<div class="ratings">
	...
	{{ $cars->appends(['minprice' => request()->input('minprice'), 'maxprice' => request()->input('maxprice'), 'country_id' => request()->input('country_id'), 'sort' => request()->input('sort'), 'review' => request()->input('review'),'view' => request()->input('view')])->links() }}
</div>
@else
<h4 class="text-center">{{__('Car Not Found')}}</h4>
@endif
@endif
		...
		<div class="col-lg-4 col-md-6">
			<div class="single-tours">
				...
				<div class="content">
					...
					<h4 class="title">
						<a href="{{route('tour.details',$space->slug)}}">{{$space->title}}</a>
					</h4>
					<div class="review-area">
						<div class="stars">
							<div class="ratings">
