...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Create Space') }}
    <a href="{{ url()->previous() }}" class="btn back-btn btn-sm">{{__('Back')}}</a>
    </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('user-dashboard')}}">{{ __('Dashboard') }}</a></li>
            <li class="breadcrumb-item"><a href="{{route('user-space-index')}}">{{ __('Space') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Create Space') }}</li>
        </ol>
    </div>
    @include('includes.admin.form-error') @include('includes.admin.form-success')
    <form action="{{route('user-space-store')}}" enctype="multipart/form-data" method="POST" id="pageForm">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <!-- Form Basic -->
                        ...
                        <div class="row border-buttom">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="extra_bed" id="bed" placeholder="{{ __('No. Bed') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="bathroom">{{ __('No. Bathroom') }}</label>
                                    <input type="number" class="form-control" name="extra_bathroom" id="bathroom" placeholder="{{ __('No. Bathroom') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="extra_square" id="extra_square" placeholder="{{ __('Square Fit') }}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input term-check" rel="{{$term->space_attr_id}}" name="term_id[]" value="{{$term->id}},{{$term->space_attr_id}}" id="{{$term->id}}">
...
@section('script')
<script src="{{asset('assets/user/js/space/create.js')}}"></script>
@endsection