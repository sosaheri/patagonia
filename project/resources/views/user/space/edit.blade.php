...
<div class="container-fluid" id="container-wrapper">
    ...
    <form action="{{route('user-space-update',$main->id)}}" enctype="multipart/form-data" method="POST" id="pageForm" >
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <!-- Form Basic -->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="text-center banner_image_view mb-2">
                                        <img class="img-profile" src="{{$main->banner_image ? asset('assets/images/space/banner-image/'.$main->banner_image) : asset('assets/images/noimage.png')}}" >
                                    </div>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="text-center image-view mb-4">
                            <img class="img-profile" src="{{$main->image->image ? asset('assets/images/space/feature-image/'.$main->image->image) : asset('assets/images/noimage.png')}}" >
                        </div>
                        <div class="custom-file">
