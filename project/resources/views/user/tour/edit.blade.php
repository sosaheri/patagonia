...
<div class="container-fluid" id="container-wrapper">
    ...
    <form action="{{route('user-tour-update',$main->id)}}" enctype="multipart/form-data" method="POST" id="pageForm">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <!-- Form Basic -->
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="duration" value="{{$main->duration}}" class="form-control" name="duration" placeholder="{{__('Enter Duration')}}">
                        </div>
                        ...
                        <div id="exclude-section">
                            @if ($main->exclude) @foreach(explode(',,,',$main->exclude) as $exclude)
                            <div class="language-area  position-relative">
                                <span class="remove-btn"><i class="fas fa-times"></i></span>
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-12">
                            ...
                            <div class="language-area  position-relative">
                                ...
                                <div class="row border-buttom my-3">
                                    <div class="col-sm-3 col-md-3 col-3">
                                        <img class="img-fluid inventory-image" width='80' height='80' src="{{ $inventory->image ? asset('assets/images/tour/inventory-image/'.$inventory->image) : asset('assets/images/noimage.png')}}">
                                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="text-center banner_image_view mb-2">
                                        <img class="img-profile" src="{{$main->banner_image ? asset('assets/images/tour/banner-image/'.$main->banner_image) : asset('assets/images/noimage.png')}}" >
                                    </div>
                                    <div class="custom-file">
                    ...
                    <div class="card-body">
                        ...
                        <div class="persion-type d-none">
                            ...
                            <div id="persion-section">
                                @if($main->person_type && $main->person_type_min && $main->person_type_max)
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="text-center image-view mb-4">
                            <img class="img-profile" src="{{$main->image->image ? asset('assets/images/tour/feature-image/'.$main->image->image) : asset('assets/images/noimage.png')}}" >
                        </div>
                        <div class="custom-file">
			...
			<div class="modal-body">
				...
				<div class="gallery-images">
					<div class="selected-image">
						<div class="row">
                            @foreach ($main->gallery->where('type','tour')->where('imagable_id',$main->id) as $key => $gallery)
                            <div class="col-sm-6">
                                <div class="img gallery-img"><span class="remove-img" data-href="{{route('user.tour.gallery.image.remove',$gallery->id)}}"><i class="fas fa-times"></i><input type="hidden" value="{{$key}}"></span>
