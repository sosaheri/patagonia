        ...
        <div class="card h-100 bg-primary">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-white">{{App\Models\Hotel::where('author_id',$user->id)->where('author_type','user')->count()}}</div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-white">{{App\Models\TourModel::where('author_id',$user->id)->where('author_type','user')->count()}}</div>
        ...
        <div class="card h-100 bg-danger ">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-white">{{App\Models\Car::where('author_id',$user->id)->where('author_type','user')->count()}}</div>
        ...
        <div class="card h-100 bg-secondary">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-white">{{App\Models\Space::where('author_id',$user->id)->where('author_type','user')->count()}}</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-list">
                                <a href="{{route('user.hotel.order.details',$hotel->id)}}"  class="btn btn-primary btn-sm mr-2 order_details" data-toggle="modal" data-target="#viewDetails">
                                   {{__('Details')}}
                                </a>
                            </div>
                        </td>
            ...
            <table id="geniustable" class="table align-items-center table-flush  dt-responsive" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-list">
                                <a href="{{route('user.car.order.details',$car->id)}}"  class="btn btn-primary btn-sm mr-2 order_details" data-toggle="modal" data-target="#viewDetails">
                                   {{__('Details')}}
                                </a>
                            </div>
                        </td>
            ...
            <table id="geniustable" class="table align-items-center table-flush  dt-responsive" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-list">
                                <a href="{{route('user.space.order.details',$space->id)}}"  class="btn btn-primary btn-sm mr-2 order_details" data-toggle="modal" data-target="#viewDetails">
                                   {{__('Details')}}
                                </a>
                            </div>
                        </td>
            ...
            <table id="geniustable" class="table align-items-center table-flush  dt-responsive" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-list">
                                <a href="{{route('user.tour.order.details',$tour->id)}}"  class="btn btn-primary btn-sm mr-2 order_details" data-toggle="modal" data-target="#viewDetails">
                                   {{__('Details')}}
                                </a>
                            </div>
                        </td>
