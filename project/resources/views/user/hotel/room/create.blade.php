...
<div class="container-fluid" id="container-wrapper">
    ...
    <a href="{{ url()->previous() }}" class="btn back-btn btn-sm">{{__('Back')}}</a>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('user-hotel-room',$hotel_id)}}">{{ __('Hotel Room') }}</a></li>
        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{route('user-hotel-room-store')}}" enctype="multipart/form-data" method="POST" id="pageForm">
                        @csrf
                       <input type="hidden" name="hotel_id" value="{{$hotel_id}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.1" class="form-control" name="per_night_cost" id="per_night_cost" placeholder="{{ __('Per Night Price') }}">
                            </div>
                          </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script>
	...
	$("#uploadgallery").change(function () {
		...
		for (var i = 0; i < total_file; i++) {
			...
			$('#pageForm').append('<input type="hidden" name="galval[]" id="galval' + i +
