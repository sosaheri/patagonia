...
class TourRezorpayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!in_array($request->currency_code,$supported)){
            return redirect()->route('tour.checkout')->with('error','This currency not supported Rezorpay checkout');
        }
        ...
        $notify_url = route('tour.rezorpay.notify');
