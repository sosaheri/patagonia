...
class HotelRoomController extends Controller
{
    ...
    {
        return view('admin.hotel.room.index',compact('id'));
    }
    ...
    public function datatables($id)
    {
        ...
        return DataTables::of($datas)
            ->addColumn('action', function(HotelRoom $data) {
                return '<div class="action-list"><a href="' . route('admin-hotel-room-edit',$data->id) . '" class="btn btn-primary btn-sm mr-2"> <i class="fas fa-edit mr-1"></i>'. __('Edit') .'</a><a href="javascript:;" data-href="' . route('admin-hotel-room-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                </div>';
            })

            ->editColumn('serial', function(HotelRoom $data) {
            ...
            ->rawColumns(['action','per_night_cost','serial'])
            ->toJson();
    }
    ...
    {
        return view('admin.hotel.room.create',compact('hotel_id'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.hotel.room.edit',compact('data'));
    }
    ...
    public function RoomGalleryRemove($id)
    {
