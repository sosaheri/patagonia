...
<?php $__env->startSection('title'); ?>
	<?php echo e(__('Spaces')); ?> | <?php echo e($gs->website_title); ?>
...
<?php $__env->startSection('content'); ?>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="pages">
						...
						<li class="active">
							<a href="<?php echo e(route('front.spaces')); ?>">
								<?php echo e(__('Space')); ?>
									...
									<div class="col-lg-4 col-md-6">
										<div class="single-tours">
											<div class="img-area">
												...
												<?php endif; ?>
												<img src="<?php echo e(asset('assets/images/space/feature-image/'.$space->image->image)); ?>" alt="space-feature">
											</div>
											<div class="content">
	...
	<form id="spaces" class="d-none" action="<?php echo e(route('front.spaces')); ?>" method="GET">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devgenius/public_html/booking/project/resources/views/front/space/index.blade.php ENDPATH**/ ?>