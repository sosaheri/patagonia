...
<?php $__env->startSection('title'); ?>
	<?php echo e(__('Car Details')); ?> | <?php echo e($gs->website_title); ?>

<?php $__env->stopSection(); ?>

<?php if($car->meta_tag != null || $car->meta_description != null): ?>

<?php $__env->startSection('meta_content'); ?>
<meta property="og:title" content="<?php echo e($car->title); ?>" />
<meta property="og:description" content="<?php echo e($car->meta_description != null ? $car->meta_description : strip_tags($car->meta_description)); ?>" />
<meta property="og:image" content="<?php echo e(asset('assets/images/car/feature-image/'.$car->image->image)); ?>" />
<meta name="keywords" content="<?php echo e($car->meta_tag); ?>">
<meta name="description" content="<?php echo e($car->meta_description); ?>">
...
<?php $__env->startSection('content'); ?>
	...
	<section class="tour-details-banner" style="background: url(<?php echo e(asset('assets/images/car/banner-image/'.$car->banner_image)); ?>)">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="content">
						...
						<div class="right-video">
							<a href="<?php echo e($car->video); ?>" class="video-play-btn mfp-iframe">
				...
				<div class="col-lg-12">
					<div class="info-content">
						<div class="review-box">
							<div class="rating">
								<?php echo e($car->review()); ?> <small>/5</small>
							</div>
							<div class="review">
								<?php echo e($car->review_count()); ?> <?php echo e(__('Review')); ?>
						...
						<div class="row">
							<div class="col-xl-2 col-lg-3 col-sm-6">
								<div class="info-box">
									...
									<div class="right">
										<h5 class="title">
											<?php echo e(__('Passenger')); ?>

										</h5>
										<p>
											<?php echo e($car->passenger); ?>
							...
							<div class="col-xl-2 col-lg-3 col-sm-6">
								<div class="info-box">
									...
									<div class="right">
										<h5 class="title">
											<?php echo e(__('Baggage')); ?>

										</h5>
										<p>
											<?php echo e($car->baggage); ?>
				...
				<div class="col-lg-8">
					<div class="model-gallery-image">
						<div class="one-item-slider">
                            <?php $__currentLoopData = $car->gallery->where('imagable_id',$car->id)->where('type','car'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item"><img src="<?php echo e(asset('assets/images/car/gallery/'.$gallery->image)); ?>" alt=""></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</div>
						<ul class="all-item-slider">
                            <?php $__currentLoopData = $car->gallery->where('imagable_id',$car->id)->where('type','car'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><img src="<?php echo e(asset('assets/images/car/gallery/'.$gallery->image)); ?>" alt=""></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</ul>
					</div>
					...
					<div class="map-location-area">
						<h4 class="title">
							<?php echo e(__('Car Location')); ?> :
						</h4>
						<iframe
                            height="350"
                            frameborder="0" style="border:0; width: 100%;"
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyB1GpE4qeoJ__70UZxvX9CTMUTZRZNHcu8&q=<?php echo e($car->country->country); ?>,<?php echo e($car->state->state); ?>,<?php echo e($car->address); ?>" allowfullscreen>
                          </iframe>
					</div>
					<?php if($car->faq_title): ?>
					<div class="tour-faq-area">
						...
						<div class="accordion" id="tour-faq">
								<?php $__currentLoopData = explode(',,,',$car->faq_title); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php
					...
					<div class="review-area">
						...
						<?php echo e(__('Average Review : ')); ?> <span class="average_review"><?php echo e($car->average_review); ?></span>
						...
						<?php if(Auth::user() && App\Models\Order::where('user_id',Auth::user()->id)->where('item_id',$car->id)->where('order_type','Car')->exists()): ?>
						<?php if(App\Models\Review::where('user_id',Auth::user()->id)->where('review_id',$car->id)->exists()): ?>
						<input type="hidden" id="now_review" value="<?php echo e(App\Models\Review::where('user_id',Auth::user()->id)->where('review_id',$car->id)->first()->review); ?>">
						<?php else: ?>
						...
						<div class="write-comment-area">
							<form action="<?php echo e(route('front.review.store')); ?>" method="POST" id="reviewForm">
								...
								<input type="hidden" name="review_id" value="<?php echo e($car->id); ?>">
								<div class="row">
									<div class="col-lg-12">
					...
					<div class="aside-right">
						<div class="price-area">
							...
							<div class="book-now-area">
                                ...
                                <?php if($car->is_extra_price == 1): ?>
								<div class="extra-price-wizerd">
									<h5 class="title">
										<?php echo e(__('Extra prices')); ?>:
									</h5>
									<ul class="extra-list">
                                        <?php $__currentLoopData = explode(',,,',$car->extra_price_name); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $extra_price_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <li>
											<div class="left">
                                            <input type="checkbox" id="a<?php echo e($key); ?>" data-href="<?php echo e(PriceHelper::showPrice($price[$key])); ?>" class="car_extra_prices" value="<?php echo e($key); ?>"> <label for="a<?php echo e($key); ?>"><?php echo e($extra_price_name); ?></label>
	...
	<input type="hidden" id="carIdAjax" value="<?php echo e($car->id); ?>">
	<input type="hidden" id="ajaxQty" value="<?php echo e($qty); ?>">
	<input type="hidden" id="carMainPriceAjax" value="<?php echo e(PriceHelper::showPrice($car->main_price)); ?>">
	<input type="hidden" id="CarDataChcekUrl" value="<?php echo e(route('car.availability.check')); ?>">

<?php $__env->stopSection(); ?>

<?php $__env->startSection('script'); ?>
<script src="<?php echo e(asset('assets/front/js/car/details.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devgenius/public_html/booking/project/resources/views/front/car/details.blade.php ENDPATH**/ ?>