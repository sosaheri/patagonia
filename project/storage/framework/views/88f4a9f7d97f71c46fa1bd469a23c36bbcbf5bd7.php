...
<?php $__env->startSection('title'); ?>
	<?php echo e(__('Space Checkout')); ?> | <?php echo e($gs->website_title); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-12 mt-4">
                                        <div class="custom-control custom-checkbox">
                                          ...
                                          <button type="submit"  class="mybtn1 final-btn mt-3"><?php echo e(__('Checkout')); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="booking-info">
                            <div class="top-area">
                                <h5 class="name"><?php echo e($space['space']['title']); ?></h5>
                                <p class="location"><i class="fas fa-map-marker-alt"></i> <?php echo e($space['space']->country->country); ?>, <?php echo e($space['space']->state->state); ?></p>
                                <div class="image">
                                    <img src="<?php echo e(asset('assets/images/space/feature-image/'.$space['space']->image->image)); ?>" alt="">
                                </div>
                            </div>
                            <div class="area-two">
                                <ul>
                                    <li>
                                        ...
                                        <span><?php echo e($space['start_date']); ?></span>
                                    </li>
                                    <li>
                                        <span><?php echo e(__('End date')); ?>:</span>
                                        <span><?php echo e($space['end_date']); ?></span>
                                    </li>
                                    <li>
                                        <span><?php echo e(__('Duration')); ?>:</span>
                                        <span><?php echo e($space['night']); ?> <?php echo e(__('Night')); ?></span>
                                    </li>
                                </ul>
                            </div>
                            <?php if($space['fac_name']): ?>
                            <div class="area-three">
                                <h6 class="mt-2">
                                    <?php echo e(__('Extra Prices')); ?>:
                                </h6>
                                <ul>
                                    <?php $__currentLoopData = $space['fac_name']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $e_p_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <span><?php echo e($e_p_name); ?>: <small>(<?php echo e(str_replace('_',' ',$space['fac_type'][$key])); ?>)</small></span>
                                        <span><?php echo e(PriceHelper::showCurrencyPrice($space['fac_price'][$key])); ?></span>
                                    </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                            ...
                            <div class="area-four">
                                ...
                                <h4 class="total">
                                     <?php echo e(PriceHelper::showCurrencyPrice($space['total'])); ?>
    ...
    <input type="hidden" id="space_offline_route" value="<?php echo e(route('space.offline.payment')); ?>">
    <input type="hidden" id="space_stripe_route" value="<?php echo e(route('space.stripe.submit')); ?>">
    <input type="hidden" id="space_instamojo_route" value="<?php echo e(route('space.instamojo.payment')); ?>">
    <input type="hidden" id="space_paypal_route" value="<?php echo e(route('space.paypal.payment')); ?>">
    <input type="hidden" id="space_authorize_route" value="<?php echo e(route('space.authorize.payment')); ?>">
    <input type="hidden" id="space_mollie_route" value="<?php echo e(route('space.mollie.payment')); ?>">
    <input type="hidden" id="space_paystack_route" value="<?php echo e(route('space.paystack.payment')); ?>">
    <input type="hidden" id="space_mercadopago_route" value="<?php echo e(route('space.mercadopago.payment')); ?>">
    <input type="hidden" id="space_rezorpay_route" value="<?php echo e(route('space.rezorpay.payment')); ?>">
...
?>
<input type="hidden" value="<?php echo e($mercadopagoData['public_key']); ?>" id="spacemercadopagokey">
...
<script src="https://js.stripe.com/v2/"></script>
    <script src="<?php echo e(asset('assets/front/js/space/index.js')); ?>"></script>
    ...
    <script>
        $(document).on('submit','.step1-form',function(){
            ...
            var total = '<?php echo e(PriceHelper::showPrice($space['total'])); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devgenius/public_html/booking/project/resources/views/front/checkout/space_checkout.blade.php ENDPATH**/ ?>