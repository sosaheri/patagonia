                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-list">
                                <a href="<?php echo e(route('user.hotel.order.details',$hotel->id)); ?>"  class="btn btn-primary btn-sm mr-2 order_details" data-toggle="modal" data-target="#viewDetails">
            ...
            <table id="geniustable" class="table align-items-center table-flush  dt-responsive" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-list">
                                <a href="<?php echo e(route('user.car.order.details',$car->id)); ?>"  class="btn btn-primary btn-sm mr-2 order_details" data-toggle="modal" data-target="#viewDetails">
                                   <?php echo e(__('Details')); ?>
            ...
            <table id="geniustable" class="table align-items-center table-flush  dt-responsive" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-list">
                                <a href="<?php echo e(route('user.space.order.details',$space->id)); ?>"  class="btn btn-primary btn-sm mr-2 order_details" data-toggle="modal" data-target="#viewDetails">
                                   <?php echo e(__('Details')); ?>
            ...
            <table id="geniustable" class="table align-items-center table-flush  dt-responsive" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-list">
                                <a href="<?php echo e(route('user.tour.order.details',$tour->id)); ?>"  class="btn btn-primary btn-sm mr-2 order_details" data-toggle="modal" data-target="#viewDetails">
                                   <?php echo e(__('Details')); ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devgenius/public_html/booking/project/resources/views/user/dashboard.blade.php ENDPATH**/ ?>