...
<?php $__env->startSection('title'); ?>
	<?php echo e(__('Car Checkout')); ?> | <?php echo e($gs->website_title); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="booking-info">
                            <div class="top-area">
                                <h5 class="name"><?php echo e($car['car']['title']); ?></h5>
                                <p class="location"><i class="fas fa-map-marker-alt"></i> <?php echo e($car['car']->country->country); ?>, <?php echo e($car['car']->state->state); ?></p>
                                <div class="image">
                                    <img src="<?php echo e(asset('assets/images/car/feature-image/'.$car['car']->image->image)); ?>" alt="">
                                </div>
                            </div>
                            <div class="area-two">
                                <ul>
                                    <li>
                                        ...
                                        <span><?php echo e($car['start_date']); ?></span>
                                    </li>
                                    <li>
                                        <span><?php echo e(__('End date')); ?>:</span>
                                        <span><?php echo e($car['end_date']); ?></span>
                                    </li>
                                    <li>
                                        <span><?php echo e(__('Duration')); ?>:</span>
                                        <span><?php echo e($car['night']); ?> <?php echo e(__('Night')); ?></span>
                                    </li>
                                    <li>
                                        <span><?php echo e(__('Car Quantity')); ?>:</span>
                                        <span><?php echo e($car['qty']); ?></span>
                                    </li>
                            ...
                            <div class="area-three">
                                ...
                                <ul>
                                    <?php $__currentLoopData = $car['fac_name']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $e_p_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <span><?php echo e($e_p_name); ?>: <small>(<?php echo e(str_replace('_',' ',$car['fac_type'][$key])); ?>)</small></span>
                                        <span><?php echo e(PriceHelper::showCurrencyPrice($car['fac_price'][$key])); ?></span>
                                    </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                            ...
                            <div class="area-four">
                                ...
                                <h4 class="total">
                                     <?php echo e(PriceHelper::showCurrencyPrice($car['total'])); ?>
        ...
        <!-- Checkout Area End -->
        <input type="hidden" id="car_offline_route" value="<?php echo e(route('car.offline.payment')); ?>">
        <input type="hidden" id="car_stripe_route" value="<?php echo e(route('car.stripe.payment')); ?>">
        <input type="hidden" id="car_instamojo_route" value="<?php echo e(route('car.instamojo.payment')); ?>">
        <input type="hidden" id="car_paypal_route" value="<?php echo e(route('car.paypal.payment')); ?>">
        <input type="hidden" id="car_authorize_route" value="<?php echo e(route('car.authorize.payment')); ?>">
        <input type="hidden" id="car_mollie_route" value="<?php echo e(route('car.mollie.payment')); ?>">
        <input type="hidden" id="car_paystack_route" value="<?php echo e(route('car.paystack.payment')); ?>">
        <input type="hidden" id="car_mercadopago_route" value="<?php echo e(route('car.mercadopago.payment')); ?>">
        <input type="hidden" id="car_rezorpay_route" value="<?php echo e(route('car.rezorpay.payment')); ?>">
    ...
    ?>
    <input type="hidden" value="<?php echo e($mercadopagoData['public_key']); ?>" id="carmercadopagokey">
<?php $__env->stopSection(); ?>
...
<script>
    $(document).on('submit','.step1-form',function(){
        ...
        var total = '<?php echo e(PriceHelper::showPrice($car['total'])); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devgenius/public_html/booking/project/resources/views/front/checkout/car_checkout.blade.php ENDPATH**/ ?>