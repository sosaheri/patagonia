...
<div class="row mb-3">
        ...
        <div class="card h-100 bg-primary">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-white"><?php echo e(App\Models\Hotel::count()); ?></div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-white"><?php echo e(App\Models\TourModel::count()); ?></div>
        ...
        <div class="card h-100 bg-danger ">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-white"><?php echo e(App\Models\Space::count()); ?></div>
        ...
        <div class="card h-100 bg-secondary">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-white"><?php echo e(App\Models\Car::count()); ?></div>
  ...
  <div class="col-lg-12">
    <div class="card mb-4">
        ...
        <div class="table-responsive p-3">
            <h3 class="mb-3">
                <?php echo e(__('Recent Hotel Booking')); ?>
  ...
  <div class="col-lg-12">
    <div class="card mb-4">
        ...
        <div class="table-responsive p-3">
            <h3 class="mb-3">
                <?php echo e(__('Recent Car Booking')); ?>
...
<div class="col-lg-12">
    <div class="card mb-4">
        ...
        <div class="table-responsive p-3">
            <h3 class="mb-3">
                <?php echo e(__('Recent Space Booking')); ?>
...
<div class="col-lg-12">
    <div class="card mb-4">
        ...
        <div class="table-responsive p-3">
            <h3 class="mb-3">
                <?php echo e(__('Recent Tour Booking')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/patagonia/project/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>